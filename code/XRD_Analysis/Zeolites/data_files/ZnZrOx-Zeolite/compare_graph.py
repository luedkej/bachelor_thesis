...
def plot_xy_files():
    ...
    for i, file_name in enumerate(xy_files):
        ...
        axs[i].axvline(
            x=8.6, color="red", linestyle="--", linewidth=1
        )  # Add vertical line
        axs[i].axvline(
            x=13.2, color="red", linestyle="--", linewidth=1
        )  # Add vertical line
        axs[i].axvline(
            x=22.1, color="red", linestyle="--", linewidth=1
        )  # Add vertical line
        axs[i].axvline(
            x=30.5, color="red", linestyle="--", linewidth=1
        )  # Add vertical line
        axs[i].axvline(
            x=35.3, color="violet", linestyle="--", linewidth=1
        )  # Add vertical line
    ...
    plt.xlim(5, 40)
    plt.tight_layout()
    plt.savefig("ZnZrOx-Zeolite_combined.png")
